...
from LongShortTermMemoryNetworks import LongShortTermMemoryNetworks
...
if __name__ == "__main__":
    ...
    # Model creation
    hidden_dim = 4
    model = LongShortTermMemoryNetworks(X, Y, hidden_dim, 
    ...
    plt.savefig('Example_LSTM.eps', format='eps', dpi=1000)